...
//    }
    ...
    // The request: http://localhost:8090/greeting/name?name2=Tom
    // should produce: Hello Tom!
    @RequestMapping("/greeting/{name}")
    public String greetingName2(@PathVariable String name, @RequestParam(value="name2", required=false, defaultValue="World") String name2, Model model) {
